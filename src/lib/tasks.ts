...
export type TaskType = "info" | "clip" | "merge" | "split" | "video-variants" | "jianying-plan" | "jianying-draft" | "auto-plan" | "auto-render" | "auto-simulate" | "creator-suite" | "trend-report" | "trend-research" | "trend-evidence" | "script-generate" | "material-import" | "material-analysis" | "remotion-render" | "narrated-render" | "full-chain" | "publish-dry-run" | "publish-queue" | "publish-approve" | "publish-dispatch" | "publish-preflight" | "analytics-import" | "n8n-orchestration";
